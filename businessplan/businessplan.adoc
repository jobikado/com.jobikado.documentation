...
Jobikado stellt als Plattform eine Technologie bereit, die es ermöglicht, sukzessive zu wachsen. Zunächst werden Profile der Akteure auf Jobikado verarbeitet, dann wird die "Jobikado-Weiche" bestimmt und Jobangebot sowie Messaging-Bus zu den Kernkomponenten hinzugefügt.

Durch Marketing und Freund-von-Freund-Benachrichtigungen wird von Jobikado zunächst eine User-Zahl von 500 anvisiert, um weiteres wichtiges Feedback zu erlangen. Durch einen iterativen Verbesserungsprozess kann die Plattform an den Features feilen und die Nachfrage durch markttaugliche Produktoptimierungen erhöhen. Mit dem Abo-Modell wird Jobikado monatliche Einkünft generieren, die für Stabilität und Sicherheit beim Wachsen des Unternehmens sorgen. Die eingenommen Gelder werden zunehmend für den Ausbau der Plattform genutzt. 

Der Fokus des Geschäfts liegt auf der Bereitstellung der Jobikado-Plattform, deren kontinuierliche Optimierung und sämtliche Supportaktivitäten, die im Matching der Fachkräfte mit den Unternehmen anfallen, um eine hohe Bereitschaft der Unternehmen zur Zahlung der regelmäßigen Abo-Gebühren sicherzustellen.

Jobikado wird also folgende Aktivitäten immer in Eigenregie durchführen:

* Entwicklung und Optimierung der Plattform
* Kundensupport für Unternehmen und Fachkräfte
* Rechnungsabwicklung
* Akquisetätigkeit

Die Akquisetätigkeit wird ausschließlich von Jobikado selbst durchgeführt, da das Geschäftsmodell auf gegenseitigem Vertrauen basiert und nicht von teilnehmenden Unternehmen durchgeführt werden sollte. Auch eine Ausgliederung an Dienstleister verbietet sich.
